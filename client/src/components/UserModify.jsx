...
export const UserModify = ({ closeModalHandler, submitForm, currentUser }) => {
    const [formValues, setFormValues] = useState({
        ...
        address: {
            country: currentUser ? currentUser.address.country : "",
            city: currentUser ? currentUser.address.city : "",
            street: currentUser ? currentUser.address.street : "",
        ...
        <div className="overlay">
            ...
            <div className="modal">
                <div className="user-container">
                    ...
                    <form
                        onSubmit={(event) =>
                            submitForm(event, formValues, currentUser?._id)
                        }
                    >
